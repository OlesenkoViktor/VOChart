//
//  VOChartViewDataSource.swift
//  Stock
//
//  Created by VOlesenko on 1/22/16.
...
@objc
public protocol VOChartViewDataSource {
    /**
     ...
     */
    func chartViewNumberOfLines(chartView: VOChartView) -> Int
     ...
     */
    func chartView(chartView: VOChartView, valuesForLine lineIndex: Int) -> [CGFloat]
     ...
     */
    func chartView(chartView: VOChartView, colorForLine lineIndex: Int) -> UIColor?
     ...
     */
    optional func chartView(chartView: VOChartView, nameForLine lineIndex: Int) -> String
}
